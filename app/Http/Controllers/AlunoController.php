...
class AlunoController extends Controller
{
    ...
    {
        $alunos = Aluno::all();
        $alunos_data_nascimento_0510=Aluno::where('data_nascimento','2005-10-05')->get();
        $alunos_0101=Aluno::where('data_nascimento','<','2006-01-01')->get();
        $alunos_0406=Aluno::whereBetween('data_nascimento', ['2004-01-01', '2006-12-31'])->get();
        $alunos_silva=Aluno::where('nome','like','%Silva%')->get();
        $alunos_dt_email=Aluno::where('data_nascimento','>','2005-01-01')
        ->where('email', 'like', '%gmail.com%')
        ->get();
        return view('aluno.index', compact('alunos', 'alunos_data_nascimento_0510', 'alunos_0101', 'alunos_0406', 'alunos_silva', 'alunos_dt_email')); 
    }
